...
namespace SignalRApi.Hubs
{
	public class SignalRHub : Hub
	{
		...
		public async Task SendStatistic()
		{
			...
			await Clients.All.SendAsync("RecevieProductCountByCategoryDrink", value6);

			var value7 = _productService.TProductPriceAvg();
			await Clients.All.SendAsync("RecevieProductPriceAvg", value7.ToString("0.00") + "₺");
		...
		{
			var value = _notificationService.TNotificatonCountByStatusFalse();
		...
		{
			clientCount++;
			await Clients.All.SendAsync("ReceveClientCount", clientCount);
